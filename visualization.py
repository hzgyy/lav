...
def main(ckpt,args):
    ...
    for i in tqdm(range(5)):
        ...
        a_emb_2d = tsne.fit_transform(a_emb_reduced)
        print(f"TSNE reduced shape:{a_emb_2d.shape}")
        embs_all.append(a_emb_2d)
        labels = np.zeros((a_emb_2d.shape[0],),dtype=int)
        labels[::] = i
    ...
    embs_all_2d = np.concatenate(embs_all,axis=0)
