...
CONFIG.GPUS = 1
CONFIG.SEED = 0
CONFIG.BASEMODEL = 'resnet' #'resnet'

CONFIG.TRAIN = edict()

CONFIG.TRAIN.NUM_FRAMES = 20
CONFIG.TRAIN.EPOCHS = 100
CONFIG.TRAIN.SAVE_INTERVAL_ITERS = 250
CONFIG.TRAIN.LR = 1e-4
CONFIG.TRAIN.WEIGHT_DECAY = 1e-5
CONFIG.TRAIN.BATCH_SIZE = 4

CONFIG.TRAIN.FREEZE_BASE = True
...
CONFIG.LOSSES.L2_NORMALIZE = False

# TCC Parameters
CONFIG.TCC = edict()
CONFIG.TCC.EMBEDDING_SIZE = 128
CONFIG.TCC.CYCLE_LENGTH = 2
CONFIG.TCC.LABEL_SMOOTHING = 0
...
CONFIG.DATA.CONTEXT_STRIDE = 5  # stride between context frames
